...
import jason_config_reader as jsw
...
def writeActivityData(wb,actId,actName,dataList):
    ...
    for i in range(0,len(actId)):
        ...
        worksheet.write(jsw.getPrint_ActSheet_ActivityName_Heading()[0],jsw.getPrint_ActSheet_ActivityName_Heading()[1], 'ACTIVITY NAME', format)
        worksheet.write(jsw.getPrint_ActSheet_ActivityName_Value()[0],jsw.getPrint_ActSheet_ActivityName_Value()[1], LactName.upper(), format)
        worksheet.write(jsw.getPrint_ActSheet_ActivityID_Heading()[0],jsw.getPrint_ActSheet_ActivityID_Heading()[1], 'ACTIVITY ID', format)
        worksheet.write(jsw.getPrint_ActSheet_ActivityID_Value()[0],jsw.getPrint_ActSheet_ActivityID_Value()[1], dataList[i][0], format)
        worksheet.write(jsw.getPrint_ActSheet_ContractorName_Heading()[0],jsw.getPrint_ActSheet_ContractorName_Heading()[1], 'CONTRACTOR', format)
        worksheet.write(jsw.getPrint_ActSheet_ContractorName_Value()[0],jsw.getPrint_ActSheet_ContractorName_Value()[1], dataList[i][7], format)
        worksheet.write(jsw.getPrint_ActSheet_UnitName_Heading()[0],jsw.getPrint_ActSheet_UnitName_Heading()[1], 'UNIT', format)
        worksheet.write(jsw.getPrint_ActSheet_UnitName_Value()[0],jsw.getPrint_ActSheet_UnitName_Value()[1], dataList[i][5], format)
        ...
        worksheet.write(jsw.getPrint_Across_ActSheet_ActivityID_Heading()[0],jsw.getPrint_Across_ActSheet_ActivityID_Heading()[1], 'ACTIVITY ID', green_color_format)
        worksheet.write(jsw.getPrint_Across_ActSheet_Date_Heading()[0],jsw.getPrint_Across_ActSheet_Date_Heading()[1], 'DATE', green_color_format)
        worksheet.write(jsw.getPrint_Across_ActSheet_Installed_Heading()[0],jsw.getPrint_Across_ActSheet_Installed_Heading()[1], 'INSTALLED', green_color_format)
        worksheet.write(jsw.getPrint_Across_ActSheet_CompletedToday_Heading()[0],jsw.getPrint_Across_ActSheet_CompletedToday_Heading()[1], 'COMPLETED TODAY', green_color_format)
        worksheet.write(jsw.getPrint_Across_ActSheet_CompletedToDate_Heading()[0],jsw.getPrint_Across_ActSheet_CompletedToDate_Heading()[1], 'COMPLETE TO DATE', green_color_format)
        worksheet.write(jsw.getPrint_Across_ActSheet_PlannedToDate_Heading()[0],jsw.getPrint_Across_ActSheet_PlannedToDate_Heading()[1], 'PLANNED TO DATE', green_color_format)
...
try:
    ...
    fname = jsw.getoutfileName()
    workbook = xlsxwriter.Workbook(fname)
    # create the first sheet - Overview
    sheetN = jsw.getOverviewSheetName()
    ...
    worksheet.write(jsw.getPrintProjectName_Heading()[0],jsw.getPrintProjectName_Heading()[1],'PROJECT',format)
    worksheet.write(jsw.getPrintProjectName_Value()[0],jsw.getPrintProjectName_Value()[1],str(finalList[0][2]))
    worksheet.write(jsw.getPrintProjectID_Heading()[0],jsw.getPrintProjectID_Heading()[1], 'PROJECT#',format)
    worksheet.write(jsw.getPrintProjectID_Value()[0],jsw.getPrintProjectID_Value()[1], str(finalList[0][1]))
    worksheet.write(jsw.getPrint_ContractorName_Heading()[0],jsw.getPrint_ContractorName_Heading()[1], 'SUBCONTRACTOR',format)
    worksheet.write(jsw.getPrint_ContractorName_Value()[0],jsw.getPrint_ContractorName_Value()[1], str(finalList[0][7]))
    worksheet.write(jsw.getPrint_Updated_Heading()[0],jsw.getPrint_Updated_Heading()[1], 'UPDATED',format)
    worksheet.write(jsw.getPrint_Updated_Value()[0],jsw.getPrint_Updated_Value()[1], str(dateTime))
    ...
    worksheet.write(jsw.getPrint_ProjectSummary_Heading()[0],jsw.getPrint_ProjectSummary_Heading()[1], 'PROJECT SUMMARY',green_color_format)

    #--- Now write the heading for activities-------------------------
    worksheet.set_column(jsw.getPrint_ActivityID_Heading()[0],jsw.getPrint_ActivityID_Heading()[1],10)
    worksheet.write(jsw.getPrint_ActivityID_Heading()[0],jsw.getPrint_ActivityID_Heading()[1], 'ACTIVITY ID', format)
    worksheet.set_column(jsw.getPrint_ActivityName_Heading()[0],jsw.getPrint_ActivityName_Heading()[1], 30)
    worksheet.write(jsw.getPrint_ActivityName_Heading()[0],jsw.getPrint_ActivityName_Heading()[1],'ACTIVITIES',format)
    worksheet.set_column(jsw.getPrint_TotalQuantities_Heading()[0], jsw.getPrint_TotalQuantities_Heading()[1], 15)
    worksheet.write(jsw.getPrint_TotalQuantities_Heading()[0],jsw.getPrint_TotalQuantities_Heading()[1], 'TOTAL QUANTITIES',format)
    worksheet.set_column(jsw.getPrint_UnitID_Heading()[0],jsw.getPrint_UnitID_Heading()[1], 7)
    worksheet.write(jsw.getPrint_UnitID_Heading()[0],jsw.getPrint_UnitID_Heading()[1], 'UNIT ID', format)
    worksheet.write(jsw.getPrint_UnitName_Heading()[0],jsw.getPrint_UnitName_Heading()[1], 'UNITS', format)
    worksheet.set_column(jsw.getPrint_Planned_Heading()[0],jsw.getPrint_Planned_Heading()[1], 15)
    worksheet.write(jsw.getPrint_Planned_Heading()[0],jsw.getPrint_Planned_Heading()[1], 'PLANNED', format)
    worksheet.set_column(jsw.getPrint_Actual_Heading()[0],jsw.getPrint_Actual_Heading()[1], 15)
    worksheet.write(jsw.getPrint_Actual_Heading()[0],jsw.getPrint_Actual_Heading()[1], 'ACTUAL', format)


    # --- Write the activity list from the list and color the subsequent row with magenta color
    j = int(jsw.getPrint_Activity_Heading())
